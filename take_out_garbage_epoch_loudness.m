...
%load preproc data
load(strcat(pp.file_id,'_inst-loudness.mat'));

% preproc = ft_selectdata(d,'channel',{'all','-RM','-REF_LM','-Fp1'}) % OBSOLETE
preproc =d
...
d.filename = strcat(pp.file_id,'_inst-loudness_reject.mat');
d.c = cfg;
